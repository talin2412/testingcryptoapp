...
import { useGetCryptosDetailQuery } from '../services/cryptoDetailsApi';
...
const CryptoDetails = () => {
    ...
    console.log(uuid)
    const { data, isFetching } = useGetCryptosDetailQuery(uuid)
    ...
    return (
        <Col className='coin-detail-container'>
            ...
            <Col className='stats-container'>
                <Col span={12} className='coin-value-statistics'>
                ...
                <Col span={12} className='other-stats-info'>
                    <Col className='coin-value-statistics-heading'>
